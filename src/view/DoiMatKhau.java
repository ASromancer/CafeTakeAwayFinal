...
public class DoiMatKhau extends javax.swing.JFrame {
    ...
    private void buttonLuuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonLuuActionPerformed
        // TODO add your handling code here:
        NhanVien nv = new DAO().getNhanVien();
        TaiKhoan tk = new DAO().getTaiKhoan(nv);
        if (txtMatKhauCu.getText().equals(tk.getMAT_KHAU())) {
            if (textMatKhauMoi.getText().equals(txtMatKhauCu.getText())) {
                JOptionPane.showMessageDialog(rootPane, "Mat khau moi trung voi mat khau cu!");
            } else {
                tk.setMAT_KHAU(textMatKhauMoi.getText());
                if (new DAO().updateMATKHAUNV(nv, tk)) {
